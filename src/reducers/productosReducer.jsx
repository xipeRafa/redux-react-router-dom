import {            AGREGAR_PRODUCTO,    AGREGAR_PRODUCTO_EXITO,    AGREGAR_PRODUCTO_ERROR,
         COMENZAR_DESCARGA_PRODUCTOS,  DESCARGA_PRODUCTOS_EXITO,  DESCARGA_PRODUCTOS_ERROR,
           OBTENER_PRODUCTO_ELIMINAR,  PRODUCTO_ELIMINADO_EXITO,  PRODUCTO_ELIMINADO_ERROR,
             OBTENER_PRODUCTO_EDITAR,    PRODUCTO_EDITADO_EXITO,    PRODUCTO_EDITADO_ERROR } from '../types';
...
const initialState = {
  ...
  export default function(state = initialState, action) {
      switch(action.type) {
            ...
            case  OBTENER_PRODUCTO_EDITAR: return { ...state, productoeditar: action.payload }
